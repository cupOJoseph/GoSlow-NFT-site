...
export default function Home() {
  ...
  const { open: isConnectKitModalOpen, setOpen: openConnectKitModal, openSwitchNetworks } = useModal()
  ...
  const mint = async (amount: number) => {
    ...
    try {
      ...
      const pricePerNFT = parseEther("0.005");
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="flex justify-center fixed top-0 left-0 right-0 z-50 border-b bg-background/80 backdrop-blur-sm">
        <div className="w-full flex h-16 items-center justify-between px-6 gap-4">
          <a href="https://www.nerite.org/" target="_blank" rel="noopener noreferrer" className="text-xl font-semibold hover:text-primary">
            Nerite
          </a>
      ...
      <Dialog open={isThankYouDialogOpen} onOpenChange={setIsThankYouDialogOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader className="flex flex-col items-center">
            <DialogTitle className="text-2xl">Thank you for minting! 🎉</DialogTitle>
            <DialogDescription className="text-center text-md">
              We appreciate your support in the Nerite protocol and being part of our community. Share your mint with others!
            </DialogDescription>
          </DialogHeader>
